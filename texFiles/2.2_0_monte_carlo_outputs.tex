...
($v_{3D}(t_{obs})$) are provided. The three characteristic
distances include the maximum 3D separation ($d_{max}$),
which is the distance between the position of collision to
the apoapsis; the projected separation $d_proj$ and the three
