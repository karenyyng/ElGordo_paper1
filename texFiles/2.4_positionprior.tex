...
\end{equation}
where $0 < \beta < 1.0$ is a factor that we introduce to denote a slow-down
of the relic. 
...
deceleration while some dissipative processes may have slowed down the shock wave slightly. It is unlikely that there
