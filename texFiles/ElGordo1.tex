...
values, such astime-since-collision to be larger than the age of universe at the
...
Even though we denoted the weights for one variable at a time 
...
\citealt{Ricker98}), an impact
parameter as small as 0.012 Mpc can result in substantial asymmetry. 
The X-ray morphology of El Gordo is approximately symmetric about the merger axis. 
The simulations of \cite{Ricker98} of bimodal mergers of dark matter
...
the parameter space, and that other impact parameter may also match the
...
The adopted spatial cut is approximately perpendicular to the 2D merger axis and is consistent with
