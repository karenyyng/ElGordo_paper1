...
around from the apocenter for the first time (See Fig~\ref{fig:merger_cartoon}).
\begin{figure*}
...
\section{DATA} 
We gathered and analyzed data from multiple sources. We examined the
