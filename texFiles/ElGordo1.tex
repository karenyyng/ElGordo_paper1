...
merging clusters with $\beta \approx 2.0$ has been reported by cosmological
simulations (merger F) with a time resolution of 0.6 Gyr \citep{Paul2011b}. \par 
...
features of El Gordo. Both estimates fit within the approximate
...
BCGS tend to mark the bottom of the potential, so this further supports the
