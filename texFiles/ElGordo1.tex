...
\begin{table*}
	...
	\caption{List of variables that provide quantitative constraints for the merger
		scenario. For details of each variable see the corresponding
	$^\dagger$Section.}
\begin{center} 
\begin{tabular}{@{}lccccc}
...
Time averaged speed of NW relic in the CM frame ($\langle v_{relic} \rangle$) &
 3.4 &  km~s$^{-1} $ & 4.1 \\ 
Projected separation of SE relic from the CM ($s_{proj}$)  & 1.1  & Mpc & 3.4 \\ 
Projected separation of NW relic from the CM ($s_{proj}$)  & 0.63 & kpc & 3.4 \\ 
Outgoing time-since-pericenter ($TSP_{out}$)  &  0.61 & Gyr & 3.2, 4.1 \\ 
Returning time-since-pericenter ($TSP_{ret}$)  & 1.0 & Gyr & 3.2, 4.1 \\ 
Age of the universe at z = 0.87 & 6.30 & Gyr&  \\ 
Free fall velocity of subclusters & 4500 & km~s$^{-1}$ & 3\\  
Polarization fraction of NW relic ($\langle P_{strong} \rangle$) & 33\% &  & 3.3.1 \\ 
\hline 
\end{tabular} 
\end{center} 
\label{tab:inputs} 
...
available at \href{https://github.com/karenyyng/ElGordo\_paper1}{https://github.com/karenyyng/ElGordo_paper1}. 

\bibliographystyle{mn2e}
\bibliography{ElGordo1}
\appendix
