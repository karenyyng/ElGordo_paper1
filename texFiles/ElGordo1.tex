...
time-since-collision estimates are $0.46\pm^{0.09}_{0.16}$ Gyr and $0.91\pm^{0.22}_{0.39}$ Gyr
...
largest amount of uncertainty to the dynamical variables \citepalias{D13}.
...
properties of the shocks, are also important. 
We urge simulators to provide more estimates of the global
properties of the shocks for understanding the merger scenario. 
