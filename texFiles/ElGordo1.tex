...
lead the corresponding cool core by $\sim 0.08~\mega$pc, assuming they are
propagating outwards. On the other hand, indirect observables of the merger
...
interior of the cluster than the corresponding DM subcluster mass
...
later stage of a merger. (See Fig. \ref{fig:merger_scenario})\par 
...
% cite Markevitch paper about the self-interacting cross section 
% talk about how different variables would have different effects 


% spatial separation of gas-DM not really great for constraining sigma
% 
