...
relative velocities of the subcluster at collision. Magnitude of $v_{3D}$
drops as the subclusters climb out of the gravitational potential of each
...
TO BE REPLACED BY A PARAGRAPH DENOTING WHAT ARE THE RANGE OF SHOCK WAVE
SPEEDS ARE NEEDED TO BREAK THE DEGENERACIES
...
In addition, we showed that understanding individual mergers can be
improved by a better understanding of the physical constraints of the
merger shocks from cosmological simulations. Important pending questions include: 
What are the typical velocities of the shockwave that corresponds to the
radio relic in the	center of mass frame of the cluster? What physical properties of the DM subclusters would correlate the best with the time-evolution of the velocity of the shockwave?  What are the duration after merger for which radio relics are
observable in terms of the merger oscillation time-scales?\\ 
...
1) favors the estimate of a small projection angle  
2) shows a low observed radial velocity and collisional velocity of El Gordo given its high
mass  
3) predicts an outgoing scenario if the time-averaged merger shock velocity
is $> 2800~\kilo \meter~\second^{-1}$ between the collision and the
observation 
