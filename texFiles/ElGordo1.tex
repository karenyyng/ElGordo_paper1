...
bootstrap_redshift}). 
The quoted radial velocity difference of $586~\kilo \meter~\second^{-1}$ reported by \citetalias{M12} 
...
We provide estimates of the dynamical parameters of El Gordo using our
...
\begin{enumerate}
	\item demonstrated the first use of polarization fraction information from
		...
		$43\degree^{26}_{24}$ to $21 \degree
		\pm^{9}_{11}$ (See	Fig. \ref{fig:geom_geom})\\ 
	\item 
		inferred a {\it relative} collisional velocity between the subclusters of El
		Gordo as $2400\pm^{400}_{200}~\kilo\meter~\second^{-1}$ \\ 
...
\end{enumerate}
As large scale sky surveys come online, more and more galaxy cluster merger
would become available and more cluster mergers at later stages of their merger
would be discoverd. El Gordo will serve as one of the best studied
example of a late-stage cluster merger for comparison.  
